            ...
            <div className="bg-slate-800 border-slate-400 rounded-md p-8 shadow-lg backdrop-filter backdrop-blur-sm bg-opacity-30">
                ...
                <form action="">
                    <div className=" relative my-4">
                        <input type="email" className="block w-72 py-2.3 px-0 text-sm text-white bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:focus:border-indigo-50 focus:outline-none focus:ring-0 focus-text-white focus:border-indigo-100 peer" placeholder=""/>
                    ...
                    <div className=" relative my-4">
                        <input type="password" className="block w-72 py-2.3 px-0 text-sm text-white bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:focus:border-indigo-50 focus:outline-none focus:ring-0 focus-text-white focus:border-indigo-100 peer" placeholder=""/>
                    ...
                    <button className="w-full mb-4 text-[18] mt-6 rounded-full bg-white text-indigo-950 hover:text-indigo-300 py-2" type="submit">Login</button>
            <div>
